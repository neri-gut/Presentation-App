...
// node_modules/.pnpm/mutative@1.2.0/node_modules/mutative/dist/mutative.esm.mjs
var Operation = {
  Remove: "remove",
  Replace: "replace",
  Add: "add"
...
// node_modules/.pnpm/use-mutative@1.3.0_@types+react@19.1.8_mutative@1.2.0_react@19.1.0/node_modules/use-mutative/dist/index.esm.js
var import_react = __toESM(require_react());
function a(u2, s2) {
  const a2 = (0, import_react.useRef)({ patches: [], inversePatches: [] }), o2 = (0, import_react.useRef)(0), p = (0, import_react.useRef)(0);
  let h = o2.current;
  (0, import_react.useEffect)(() => {
    o2.current = h, p.current = h;
  }), h += 1, p.current += 1;
  const [l, i] = (0, import_react.useState)(() => "function" == typeof u2 ? u2() : u2), v = (0, import_react.useCallback)((r2) => {
    i((t2) => {
      const n2 = create(t2, "function" == typeof r2 ? r2 : () => r2, s2);
      return (null == s2 ? void 0 : s2.enablePatches) ? (p.current !== o2.current && p.current !== o2.current + 1 || (Array.prototype.push.apply(a2.current.patches, n2[1]), Array.prototype.unshift.apply(a2.current.inversePatches, n2[2])), n2[0]) : n2;
    });
  }, []);
  return (0, import_react.useEffect)(() => {
    (null == s2 ? void 0 : s2.enablePatches) && (a2.current.patches = [], a2.current.inversePatches = []);
  }), (null == s2 ? void 0 : s2.enablePatches) ? [l, v, a2.current.patches, a2.current.inversePatches] : [l, v];
}
function o(n2, c2, a2, o2) {
  const p = (0, import_react.useRef)({ patches: [], inversePatches: [] }), h = (0, import_react.useRef)(0), l = (0, import_react.useRef)(0);
  let i = h.current;
  (0, import_react.useEffect)(() => {
    h.current = i, l.current = i;
  }), i += 1, l.current += 1;
  const v = (0, import_react.useMemo)(() => (r2, t2) => {
    const c3 = create(r2, (e) => n2(e, t2), o2);
    return (null == o2 ? void 0 : o2.enablePatches) ? (l.current !== h.current && l.current !== h.current + 1 || (Array.prototype.push.apply(p.current.patches, c3[1]), Array.prototype.unshift.apply(p.current.inversePatches, c3[2])), c3[0]) : c3;
  }, [n2]), y = (0, import_react.useReducer)(v, c2, a2);
  return (0, import_react.useEffect)(() => {
    (null == o2 ? void 0 : o2.enablePatches) && (p.current.patches = [], p.current.inversePatches = []);
  }), (null == o2 ? void 0 : o2.enablePatches) ? [y[0], y[1], p.current.patches, p.current.inversePatches] : y;
}
export {
  a as useMutative,
  o as useMutativeReducer
};
//# sourceMappingURL=use-mutative.js.map
